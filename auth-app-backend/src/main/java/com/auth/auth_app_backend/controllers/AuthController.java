...
public class AuthController {
    ...
    // access token and refresh token renew karne ke lie api hai
    @PostMapping("/refresh")
    public ResponseEntity<TokenResponse> refreshToken(
        ...
        cookieService.attachedRefreshCookie(response, newRefreshToken, (int) jwtService.getRefreshTtlSeconds());
        cookieService.addNoStoreHeaders(response);
