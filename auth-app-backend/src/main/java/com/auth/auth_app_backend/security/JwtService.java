...
public class JwtService {
    ...
    private final SecretKey key; // for creating this go to the git bash and write "openssl rand -base64 64"
    ...
    public JwtService(
        ...
        if (secret == null || secret.length() < 64) {
            throw new IllegalArgumentException("Secret must be at least 64 characters");
        }
