...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ApiError> handleAuthException(Exception e, HttpServletRequest request){
        ...
        var aipError = ApiError.of(HttpStatus.BAD_REQUEST.value(),"Bad request", e.getMessage(), request.getRequestURI(), true);
        return ResponseEntity.badRequest().body(aipError);
    }
